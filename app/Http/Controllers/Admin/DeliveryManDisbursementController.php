...
use App\Models\OfflinePaymentMethod; //Metodo offline
    ...
    public function list(Request $request)
{
    ...
    // NUEVO: consulta métodos de pago offline activos
    $offlineMethods = OfflinePaymentMethod::where('status', 1)->get();

    // SOLO DEJA ESTA LÍNEA DE RETURN
    return view('admin-views.dm-disbursement.index', compact('disbursements','status', 'offlineMethods'));
}
