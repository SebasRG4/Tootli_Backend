...
class Category extends Model
{
    ...
    /**
 * Define la relación muchos-a-muchos: una categoría puede tener muchas tiendas.
 *
 * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
 */
    public function stores()
    {
        // El segundo argumento 'category_store' es opcional si seguiste la convención de nombres,
