    ...
    public function getUpdateData(Object $request, Object $deliveryMan): array
{
    ...
    // AGREGADO: obtiene el máximo global configurable
    ...
    return [
        ...
        "image" => $imageName,
        "earning" => $request->earning,
        // AGREGADO: campo max_cash_balance (nunca mayor al global)
        "max_cash_balance" => min($request->input('max_cash_balance', 350), $globalMax),
